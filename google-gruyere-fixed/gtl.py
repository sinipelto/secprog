...
# TODO Added function for escaping text to HTML
...
def _ExpandVariable(var, specials, params, name, default=''):
  ...
  if escaper_name == 'text':
    value = _EscapeTextToHtml(str(value))   # TODO Escape text to HTML correctly
  elif escaper_name == 'color':  # TODO added color processing
    value = sanitize._SanitizeColor(str(value))
